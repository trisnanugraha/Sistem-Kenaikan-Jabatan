<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $("#tabelpesan").DataTable({
            ...
            "autoWidth": false,
            "language": {
                "sEmptyTable": "Data Pesan Masuk Kopi Masih Kosong"
            },
            ...
            "columnDefs": [{
                ...
                "render": function(data, type, row) {
                    return "<a class=\"btn btn-xs btn-outline-danger\" href=\"javascript:void(0)\" title=\"Delete\"  onclick=\"del(" + row[5] + ")\"><i class=\"fas fa-trash\"></i> Hapus</a></div>";
                },
    ...
    function del(id) {
        Swal.fire({
            ...
            if (result.value) {
                $.ajax({
                    url: "<?php echo site_url('pesan/delete'); ?>",
                    type: "POST",
                    data: "id=" + id,
                    cache: false,
                    dataType: 'json',
