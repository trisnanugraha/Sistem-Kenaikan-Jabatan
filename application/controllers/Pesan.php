...
class Pesan extends MY_Controller
{
    ...
    public function index()
    {
        ...
        if ($logged_in != TRUE || empty($logged_in)) {
            ...
            if ($checklevel == 'Guest') {
                ...
                $js = $this->load->view('pesan/pesan-js', null, true);
                $this->template->views('pesan/home', $data, $js);
            }
        }
    }
    ...
    public function ajax_list()
    {
        ...
        set_time_limit(3600);
        $list = $this->Mod_pesan->get_datatables();
        $data = array();
        $no = $_POST['start'];
        ...
        $output = array(
            "draw" => $_POST['draw'],
            "recordsTotal" => $this->Mod_pesan->count_all(),
            "recordsFiltered" => $this->Mod_pesan->count_filtered(),
            "data" => $data,
        );
