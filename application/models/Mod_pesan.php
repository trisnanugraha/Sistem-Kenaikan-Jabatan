...
class Mod_pesan extends CI_Model
{
    ...
    var $table = 'tbl_pesan';
    var $column_order = array('', 'nama_pengirim', 'email', 'no_hp', 'pesan');
    var $column_search = array('nama_pengirim', 'email', 'no_hp', 'pesan');
    var $order = array('id_pesan' => 'asc'); // default order 
