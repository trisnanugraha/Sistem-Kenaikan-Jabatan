...
class Mod_banner extends CI_Model
{
    ...
    var $column_order = array('', 'judul', 'deskripsi', 'judul_tombol', 'link');
    var $column_search = array('judul', 'deskripsi', 'judul_tombol', 'link');
    var $order = array('id_banner' => 'asc'); // default order 
