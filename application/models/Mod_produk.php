...
class Mod_produk extends CI_Model
{
    ...
    var $column_order = array('', 'nama_produk', 'foto_produk', 'rating_produk', 'harga_produk', 'diskon');
    var $column_search = array('nama_produk', 'foto_produk', 'rating_produk', 'harga_produk', 'diskon');
