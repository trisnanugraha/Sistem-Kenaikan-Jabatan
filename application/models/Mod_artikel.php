...
class Mod_artikel extends CI_Model
{
    ...
    var $column_order = array('', 'judul_artikel', 'thumbnail', 'author', 'tanggal_terbit', 'deskripsi');
    var $column_search = array('judul_artikel', 'thumbnail', 'author', 'tanggal_terbit', 'deskripsi');
    var $order = array('id_artikel' => 'asc'); // default order 
